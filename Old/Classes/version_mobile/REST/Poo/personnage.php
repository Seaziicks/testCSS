<table>
    ...
    <tbody>
        ...
        <tr> <td><span class="intelligence"> Intelligence </span></td>
            ...
            <?php if($personnage->_Id_Personnage==6){ $pointsCompetenceUtilises=modificationPointsDeCompetence($personnage, $pointsCompetenceUtilises); }?>
            <td> Points de compétence : <span class="<?php if(($personnage->_Niveau+floor(($personnage->_Niveau)/6))-$pointsCompetenceUtilises>0){echo "pointsdispo";}elseif(($personnage->_Niveau+floor(($personnage->_Niveau)/6))-$pointsCompetenceUtilises<0){echo "red";}?>"><?= ($personnage->_Niveau+floor(($personnage->_Niveau)/6))-$pointsCompetenceUtilises ?>  </span></td>
