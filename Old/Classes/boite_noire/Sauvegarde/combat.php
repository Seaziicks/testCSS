						...
						?><td style="text-align : center" class="test"> 
									...
									<?php
										if($competence['TempsRechargement']-$competence['Cooldown']<$competence['Durée'])
														{
															?>
															<span id="<?php echo $personnage.$i;?>">
																<span class="cddurée"><?php echo $competence['Cooldown']-$competence['Durée']; ?></span>
														...
														{
															?>
															<span id="<?php echo $personnage.$i;?>" class="rechargement">
															...
															?>
															<span id="<?php echo $personnage.$i;?>" class="nocooldown">
															</span>
									...
									?>
										...
										<div class="cadre">
											...
											<div class="entete"><i><?php echo $competence['Entête']; ?></i></div>
