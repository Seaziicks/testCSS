...
class PersonnageManager
{
    ...
    public function get($id)
    {
        ...
        $donnees['Bonus_Agilité'] = $panoplie->getBonus('Agilite');
        $donnees['Bonus_Intelligence'] = $panoplie->getBonus('Intelligence');
        $donnees['Bonus_Vitalité'] = $panoplie->getBonus('Vitalite');
        $donnees['Bonus_Ressource'] = $panoplie->getBonus('Ressource');
        $donnees['Bonus_Réussite'] = $panoplie->getBonus('Reussite');
        $donnees['Bonus_Armure'] = $panoplie->getBonus('Armure');
