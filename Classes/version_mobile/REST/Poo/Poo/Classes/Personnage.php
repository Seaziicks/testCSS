...
class Personnage
{
    ...
    public function triggerEffectReceivingCompetence($bdd, Personnage $launcher, Personnage $receiver, BonusCombat $bonusCombatLauncher, BonusCombat $bonusCombatReceiver, CompetenceEffect $competenceEffect, bool $before)
    {
    ...
    public function triggerEffectReceivingAttack($bdd, Personnage $launcher, Personnage $receiver, BonusCombat $bonusCombatLauncher, BonusCombat $bonusCombatReceiver, CompetenceEffect $competenceEffect, bool $before)
    {
        $effectsTestManager = new EffectTestManager($bdd);
        if ($before) {
