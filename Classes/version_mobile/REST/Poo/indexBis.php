            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown" data-animations="zoomIn" data-hover="dropdown">
                        ...
                        <a class="dropdown-item" href="#">Démoniste</a>
                        <a class="dropdown-item" href="#">Nain</a>
                        <a class="dropdown-item" href="#">Manipulateur de Sang</a>
                        <a class="dropdown-item" href="#">Magmaticien</a>
                        <a class="dropdown-item" href="#">Centaure</a>
                        <a class="dropdown-item" href="#">Assassin</a>
                        <a class="dropdown-item" href="#">Franklin</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
