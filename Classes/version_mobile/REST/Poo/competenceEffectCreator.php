        ...
        <div>
            ...
            <form action="" method="post" id="statform">
                ...
                effectType =>   <select type="number" name="neweffectType" id="neweffectType" style="width:175px"><br/>
                                    ...
                                    <?= optionWithSpace(15, "ReductionDegatsFlat", 3); ?>
                                    <?= optionWithSpace(16, "ReductionDegatsPourcentage", 3); ?>
                                    ...
                                    <?= optionWithSpace(21, "IgnoreArmureMagiqueFlat ", 3); ?>
                                    <?= optionWithSpace(22, "IgnoreArmureMagiquePourcentage ", 3); ?>
