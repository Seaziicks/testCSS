        ...
        <div>
            ...
            <form action="" method="post" id="statform">
                ...
                modeApplication => <select type="number" name="newmodeApplication" style="text-align : center; width : 270px;" id="newmodeApplication" rows=1 cols=15 >
                                    ...
                                    <?= optionWithSpace(7, "Cible unique après M accumulation sur cible unique", 3); ?>
                                    <?= optionWithSpace(8, "Cible unique après M accumulation sur cibles distinctes", 3); ?>
                                    <?= optionWithSpace(9, "Cible unique après M accumulation successives", 3); ?>
                                    <?= optionWithSpace(10, "Cible unique après M accumulation successives sur cible unique", 3); ?>
                                    <?= optionWithSpace(11, "Cible unique après M accumulation successives sur cibles distinctes", 3); ?>
                                    <?= optionWithSpace(12, "Effet de zone après M accumulation", 3); ?>
                                    <?= optionWithSpace(13, "Effet de zone après M accumulation sur cible unique", 3); ?>
                                    <?= optionWithSpace(14, "Effet de zone après M accumulation sur cibles distinctes", 3); ?>
                                    <?= optionWithSpace(15, "Effet de zone après M accumulation successives", 3); ?>
                                    <?= optionWithSpace(16, "Effet de zone après M accumulation successives sur cible unique", 3); ?>
                                    <?= optionWithSpace(17, "Effet de zone après M accumulation successives sur cibles distinctes", 3); ?>
                                    <?= optionWithSpace(18, "Effet sur précédentes cibles après M accumulation", 3); ?>
                                    <?= optionWithSpace(19, "Effet sur précédentes cibles après M accumulation sur cibles distinctes", 3); ?>
                                    <?= optionWithSpace(20, "Effet sur précédentes cibles après M accumulation successives", 3); ?>
                                    <?= optionWithSpace(21, "Effet sur précédentes cibles après M accumulation successives sur cibles distinctes", 3); ?>
                                </select>
