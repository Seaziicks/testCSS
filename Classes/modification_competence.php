...
<div class="limite">
    ...
    <form method="post" action="">
        <input type="radio" name="radio-choice" id="radio-choice-1"
               value="Paladin" <?php if (isset($_POST['radio-choice']) and $_POST['radio-choice'] == 'Paladin') {
            echo 'checked';
        } ?>/>
        <label for="radio-choice-1"><img src="Paladin/Paladin.png" alt=""
                                         onclick="modification_personnage('Paladin',arr)"/></label>


        <input type="radio" name="radio-choice" id="radio-choice-2"
               value="Voleur" <?php if (isset($_POST['radio-choice']) and $_POST['radio-choice'] == 'Voleur') {
            echo 'checked';
        } ?>/>
        ...
        <input type="radio" name="radio-choice" id="radio-choice-3"
               value="Démoniste" <?php if (isset($_POST['radio-choice']) and $_POST['radio-choice'] == 'Démoniste') {
            echo 'checked';
        } ?>/>
        <label for="radio-choice-3"><img src="Demoniste/Demoniste.png" alt=""
                                         onclick="modification_personnage('Démoniste',arr)"/></label>

        <input type="radio" name="radio-choice" id="radio-choice-4"
               value="Nain" <?php if (isset($_POST['radio-choice']) and $_POST['radio-choice'] == 'Nain') {
            echo 'checked';
        } ?>/>
        <label for="radio-choice-4"><img src="Nain/Nain.png" alt=""
                                         onclick="modification_personnage('Nain',arr)"/></label>

        <input type="radio" name="radio-choice" id="radio-choice-5"
               value="Manipulateur de Sang" <?php if (isset($_POST['radio-choice']) and $_POST['radio-choice'] == 'Manipulateur de Sang') {
            echo 'checked';
        } ?>/>
        <label for="radio-choice-5"><img src="Manipulateur_de_Sang/Manipulateur_de_Sang.png" alt=""
                                         onclick="modification_personnage('Manipulateur de Sang',arr)"/> </label>
...
<div class="centre">
    ...
    <div class="original">
        <div>
            Original : <br><br><br><span
                    class="competence"><?= $competence['Libellé']; ?></span><br><br><?php include('modification_competence_original.php');
            include('effets.php'); ?>
            <?php if (!empty($competence['Exemple'])) { ?><br><br></br>
                <div class="exemple"><i><?= $competence['Exemple']; ?> </i></div><?php } ?>
        </div>
    </div>
    ...
    <div class="modification">
        <div>
            ...
            <form action="modification_competence.php" method="post">
                Numéro de compétence : <input type="number" name="Id_Competence"
                                              value="<?= $competence['Id_Competence']; ?>" style="width:40px"
                                              onload="this.select()" autofocus>
            ...
            <form action="modification_competence.php" method="post" id="statform">
                ...
                <span onclick="cacher_afficher('caracteristiques_competence')"
                      class="titre_section">Caractéristiques</span><br><br><br>
                ...
                <br><br>
                <span onclick="cacher_afficher('description')"
                      class="titre_section">Descriptions et Degats</span><br><br>
                ...
                <TEXTAREA name="newFin" id="newFin" rows=3 cols=36
                          onblur="modification_description('Fin', this)"><?= $competence['Fin']; ?></TEXTAREA>
                <br>
    ...
    <div class="résultat">
        <div>
            Modifié : <br><br><br><span class="competence"
                                        id="Libelle"><?= $competence['Libellé']; ?></span><br><br><?php include('modification_competence_apercu.php');
            include('modification_competence_effets_appercu.php'); ?><br>
