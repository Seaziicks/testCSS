...
class Effect
{
    ...
    public function useEffect(PDO $bdd, Personnage $launcher, Personnage $receiver, BonusCombat $bonusCombatLauncher, BonusCombat $bonusCombatReceiver, CompetenceEffect $competenceEffect)
    {
